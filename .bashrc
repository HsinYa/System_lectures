...
if [ "$PS1" ]; then
    case $TERM in
        ...
        if [ -e /etc/sysconfig/bash-prompt-xterm ]; then
            ...
            PROMPT_COMMAND='echo -ne "\033]0;${USER}@VirtualBox:${PWD/#$HOME/~}"; echo -ne "\007"'
        fi
        ;;
        screen)
        if [ -e /etc/sysconfig/bash-prompt-screen ]; then
            ...
            PROMPT_COMMAND='echo -ne "\033_${USER}@VirtualBox:${PWD/#$HOME/~}"; echo -ne "\033\\"'
        fi
        ;;
        *)
    ...
    #[ "$PS1" = "\\s-\\v\\\$ " ] && PS1="[\u@\h \W]\\$ "
PS1="\`if [ \$? = 0 ]; then echo \[\e[36m\]^_^\[\e[0m\]; else echo \[\e[31m\]O_O\[\e[0m\]; fi\`\e[0mHsinya\e[38;05;199m@\e[33mVirtualBox \e[0m[${MYPS}] "
